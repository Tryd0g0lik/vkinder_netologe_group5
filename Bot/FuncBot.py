...
def message_new(event_message, event, vk):
	...
	elif event_message['text'].lower() == 'help':
		message_id = vk.messages.send(
			peer_id=event_message['from_id'],
			random_id=get_random_id(),
	...
	elif event_message['text'].lower() == 'search':
	...
	elif event_message['text'].lower() == 'filter':
		message_id = vk.messages.send(
			user_id=event.object.user_id,
			random_id=get_random_id(),
			message="Вывести фильтры для изменения!!!!!"
		)
	elif event_message['text'].lower() == 'favorites':
		message_id = vk.messages.send(
			user_id=event.object.user_id,
			random_id=get_random_id(),
			message="Вывести всех избранных пользователей!!!!!"
		)
	elif event_message['text'].lower() == 'blacklist':
		message_id = vk.messages.send(
			user_id=event.object.user_id,
			random_id=get_random_id(),
